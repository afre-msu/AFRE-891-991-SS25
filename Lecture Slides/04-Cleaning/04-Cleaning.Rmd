...
* Let's say your working directory is `"C:/Github/AFRE-891-SS25/"`

--

* You have a file saved at `"C:/Github/AFRE-891-SS25/assignment-1/assignment-1.Rmd"`
...
.hi-blue[2\. separate_longer_X]: separate one variable into .hi-medgrn[multiple rows]
...
.hi-medgrn.center[1\. separate_wider_X]: separate one variable into .hi-blue[multiple columns]
  * `separate_wider_delim()`: split on a .hi-purple[delimiter]
  * `separate_wider_position()`: split on .hi-red[position]
  * `separate_wider_regex()`: split on a .hi-pink[regular expression]
...
.hi-blue.center[2\. separate_longer_X]: separate one variable into .hi-medgrn[multiple rows]
  * `separate_longer_delim()`: split on a .hi-purple[delimiter]
  * `separate_longer_position()`: split on .hi-red[position]
